...
#### GPT
- [ ] Сгенерировать структуру директорий (`/frontend`, `/backend`, `/notes`, `/assets`, `/scripts`).
- [ ] Создать шаблоны системных файлов (README, LICENSE, .gitignore).
- [ ] Проверить корректность структуры и описания.
#### Codex
- [ ] Инициализировать проект через CLI (npm init, python init, и т.д.).
- [ ] Настроить окружение разработки (venv, node_modules, .env.example).
- [ ] Добавить базовые зависимости (eslint, prettier, dotenv и т.д.).
#### Серджиу
- [ ] Проверить права доступа к каталогам и файлам.
- [ ] Провести smoke-тест запуска окружения.
- [ ] Подтвердить, что структура соответствует требованиям.
...
#### GPT
- [ ] Сгенерировать шаблоны всех ключевых файлов notes (`project_plan.md`, `tasks.md`, `changelog.md`, `readme.md`).
- [ ] Описать структуру связей между файлами.
- [ ] Обеспечить единый стиль документации.
#### Codex
...
## Подмодуль 3.10 — Правило визуала и консистентности дизайна

**Описание:**  
Закрепление визуальной концепции проекта для всех страниц и интерфейсов.  
Визуальный стиль должен соблюдаться на всём сайте без необходимости индивидуальных инструкций по страницам.

**Основная концепция визуала:**  
- Современный технологичный минимализм.  
- Чистый интерфейс с акцентом на контент и функциональность.  
- Цветовая палитра: светлый фон (#F8F9FB), тёмный текст (#1E1E1E), акцент (#6C5CE7).  
- Атмосфера — инновационность и прозрачность.  
- Компоненты визуально лёгкие, без перегруженности, с деликатными тенями и плавными hover-анимациями.  
- Все элементы должны иметь одинаковую визуальную логику (отступы, скругления, шрифты).  

---

### Задачи
#### GPT
- [ ] Подготовить визуальное правило, которое Codex будет учитывать при генерации всех страниц.  
- [ ] Проверять визуальную консистентность между новыми интерфейсами.  
- [ ] Обновлять `ui_guide` при изменении визуальных принципов.

#### Codex
- [ ] При генерации страниц учитывать правило визуала (минимализм, цветовая палитра, структура).  
- [ ] Поддерживать единый дизайн-компонентный стиль.  
- [ ] Применять шрифты, цвета и отступы согласно концепции.  

#### Серджиу
- [ ] Утвердить общую визуальную концепцию сайта.  
- [ ] Контролировать соблюдение визуала при появлении новых страниц.  
- [ ] Отмечать отклонения и фиксировать их для правок в UI-гайде.  

**После выполнения:**  
> “Обнови task.md и changelog.md, зафиксируй изменения.”  

**Ревизия GPT:**  
> “GPT, проверь соответствие визуального стиля новым страницам и актуализируй ui_guide при необходимости.”
